    ...
    <div class="container" id="ifr">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="./mensajes_voz.php" class="active">
...
$query = mysqli_query($con,"select src, left(lastdata,4) as 'voicemail', start, uniqueid from cdr where lastapp = 'voicemail' order by start desc;") or die("Fallo en la consulta");
$num_rows = mysqli_num_rows($query);
        ...
        <main>
            ...
            <div class="ifr">
                <div class="select">
                    <select name="select-buzon" id="">
                        <option value="">Default <span class="material-symbols-rounded">expand_more</span></option>
                ...
                <h2>Mensajes de voz registrados</h2>
                <table class="voicemail-table">
                    <thead>
                        <tr>
                            <th>Origen</th>
                            <th>Buzon de Voz</th>
                            ...
                            for ($i=0; $i < $num_rows; $i++) { 
                               ...
                               ?>
                                <tr>
                                    ...
                                    <td><?php echo $row["voicemail"]; ?></td>
                                    <td><?php echo $row["start"]; ?></td>
                                    
                                    <td class="no-ocultar">
                                    <audio controls>
                                                        <source src="./call_records/msg0000.wav" type="audio/wav">
                                                    </audio>
                                                </td>
